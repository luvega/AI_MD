...
- **第 1 章 Linux 与生化计算基础**：暂无正式关键文献
- **第 2 章 结构来源、PyMOL 与 Chimera 可视化**：3 篇关键文献
...
- **关联章节：** 第 2 章 结构来源、PyMOL 与 Chimera 可视化
...
- **关联章节：** 第 4 章 AI 采样、分子模拟与 MD 结果解释
