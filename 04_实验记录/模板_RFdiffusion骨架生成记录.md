...
| design_id | pdb_path | motif_rmsd | refold_rmsd | interface_contacts | pae_interface | clash | secondary_structure | interface_qc_passed | discard_reason | decision |
|:---|:---|---:|---:|---:|---:|:---|:---|:---|:---|:---|
| 待填 | 待填 | 待填 | 待填 | 待填 | 待填 | pass/review/fail | 待填 | pass/review/fail | 待填 | 保留/淘汰 |
...
- 回折叠工具/版本：
- 回折叠输入路径：
- QC 阈值：motif_rmsd / refold_rmsd / interface_contacts / pae_interface。
- 失败候选是否保留文件：是/否；若保留，记录原因。
